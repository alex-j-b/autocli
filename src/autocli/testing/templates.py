...
def render_testing_module() -> str:
    ...
    return dedent(
        ...
        def run_command_contract(command_dir: Path) -> None:
            ...
            try:
                for fixture_ref in command_file.command.fixtures:
                    ...
                    raw_process = run_generated_command(
                        workspace_root,
                        site_module,
                    ...
                    output_process = run_generated_command(
                        workspace_root,
                        site_module,
        ...
        def run_generated_command(
            ...
            \"\"\"Run the generated CLI exactly as a user would invoke it.\"\"\"
        ...
        def build_command_argv(command_file, args: dict[str, object], *, replay: bool, raw: bool) -> list[str]:
            \"\"\"Build a generated CLI argv from reconstructed fixture args.\"\"\"
